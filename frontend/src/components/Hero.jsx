...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-20 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 border-b border-slate-200 dark:border-slate-800">
      
      {/* Background Decorative Gradients */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-tr from-sky-400/25 via-teal-300/15 to-transparent dark:from-sky-600/15 dark:via-cyan-500/10 blur-3xl pointer-events-none rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-sky-100/90 dark:bg-sky-950/80 text-sky-800 dark:text-sky-300 border border-sky-300/80 dark:border-sky-800 px-4 py-2 rounded-full text-xs sm:text-sm font-extrabold shadow-xs"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-slate-700 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium"
          >
          ...
          {/* Dynamic Theme Banner Search Box */}
          <motion.form
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5, delay: 0.3 }}
            onSubmit={handleSearch}
            className="bg-white/95 dark:bg-slate-900/90 p-3 sm:p-4 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-12 gap-3 transition-colors duration-300"
          >
            {/* Search Input */}
            <div className="sm:col-span-5 relative flex items-center">
              <Search className="w-5 h-5 text-slate-400 dark:text-slate-400 absolute left-4" />
              <input
                type="text"
                placeholder="Doctor name, disease, or hospital..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800/90 rounded-2xl text-slate-900 dark:text-slate-100 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-sky-500 border border-slate-200 dark:border-slate-700/80 transition-colors"
              />
            </div>
            ...
            <div className="sm:col-span-3 relative flex items-center">
              ...
              <select
                ...
                className="w-full pl-11 pr-8 py-3 bg-slate-50 dark:bg-slate-800/90 rounded-2xl text-slate-900 dark:text-slate-100 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-sky-500 border border-slate-200 dark:border-slate-700/80 appearance-none cursor-pointer transition-colors"
              >
            ...
            <div className="sm:col-span-2 relative flex items-center">
              <MapPin className="w-5 h-5 text-slate-400 dark:text-slate-400 absolute left-3 pointer-events-none" />
              <select
                value={city}
                onChange={(e) => setCity(e.target.value)}
                className="w-full pl-9 pr-6 py-3 bg-slate-50 dark:bg-slate-800/90 rounded-2xl text-slate-900 dark:text-slate-100 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-sky-500 border border-slate-200 dark:border-slate-700/80 appearance-none cursor-pointer transition-colors"
              >
          ...
          >
            <div className="flex items-center space-x-3 bg-white/90 dark:bg-slate-900/90 p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
